    ...
    <>
      <section className='py-5 bg-light'>
        <div className='bg-black py-5'>
          <h2
            className='text-center fw-semibold tracking-wide text-light'
          ...
          <div className='row g-4 mt-4'>
            {section.services?.map((service: any, idx: number) => (
              <div key={idx} className='col-md-4'>
                <div className='px-3'>
                  <span
                    className='fw-bold text-secondary mb-2 d-block'
                    style={{ fontSize: '1rem' }}
                  >
                    {service.number}
                  </span>
          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8 text-center'>
              <h2
                ...
                style={{ fontSize: '2.2rem', lineHeight: '1.5' }}
              >
                {section.humanTouch}
              </h2>
            </div>
                ...
                <div className='border border-dark bg-white p-4 h-100 d-flex flex-column'>
                  ...
                  <ul className='list-unstyled mb-4'>
                    {plan.features.map((feature: string, fIdx: number) => (
                      <li key={fIdx} className='mb-2 text-dark'>
                        {feature}
                      </li>
                    ))}
                  </ul>
                  ...
                  <a
                    className='btn btn-dark rounded-pill py-3 px-5 fw-semibold mb-4'
                    href={getWhatsAppLink(
                      lang,
                      `${section.pricing.title} - ${plan.name}`
                    )}
                    target='_blank'
